        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center w-full">
            ...
            <div className="hidden md:flex items-center space-x-8 flex-1 justify-center">
              {navItems.map((item) => (
                <Link
                  key={item.path}
                  to={item.path}
                  className={`text-secondary-gray hover:text-brand-green px-3 py-2 text-sm font-medium transition-colors ${
            ...
            <div className="hidden md:flex items-center ml-auto">
              <Link
                to="/book-inspection"
                className="bg-brand-green text-white px-6 py-2 rounded-md hover:bg-green-600 transition-colors font-medium"
              >
                Book An Inspection
              </Link>
            </div>
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="text-secondary-gray hover:text-brand-green focus:outline-none"
            >
